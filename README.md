todomanager::Project work for Ceresti Health
===========
This documentation will explain how to use the static HTML project that is required. You’ll find a zip file containing a project called Todo_Manager that was created to create a dynamic User Interface for Creseti Healthcare.
